/**********************************************************************
  ...
  Simon Hawkin <cema@cs.umd.edu> 03/1998
  - Added conditional preprocessing.

  [1] An enclosed test ("proc.c", or "encl.c").
...
int Process_a (int ignoreC , char ** ignoreV )
{
  int i,j ;     /* loop index */
...
int Process_b (int ignoreC , char ** ignoreV )
{
  int i,j ;     /* loop index */
  int scr_sem ; /* id of screen semaphore */
...
int Process_c (int ignoreC , char ** ignoreV )
{
  int i,j ;     /* loop index */
  int scr_sem ; /* id of screen semaphore */
...
int Process_d (int ignoreC , char ** ignoreV )
{
  int i,j ;     /* loop index */
  int scr_sem ; /* id of screen semaphore */
...
int Process_e (int ignoreC , char ** ignoreV )
{
  int i,j ;     /* loop index */
  int scr_sem ; /* id of screen semaphore */
