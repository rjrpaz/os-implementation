/**********************************************************************
  ...
  Modified on: February 12, 1996
	Changed naming conventions (function names have first letter
  capitalized).

  Modified by: Jeff Hollingsworth
  Modified on: February 27, 1996
	Removed warning message for BCC 4.5
...
void Wait ()   /* wait for a key from keyboard */
{
  ...
  while( Get_char() == NULL ) ;  /* Note: this is busy waiting */
}
