/*---------------------------------------------------------------------------
 ...
 Description: This program is to demonstrate mutual exclusion using
              semaphores. Without the semaphore guiding the critical
              section, the seqno will not be properly updated.
 To compile : gcc -o sem_count sem_count.c
 To run     : sem_count 1 &; sem_count 0 &
