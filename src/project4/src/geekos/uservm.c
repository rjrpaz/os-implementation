...
<<<<<<< HEAD
                        DebugVM("-> Direccion de la pagina nro. %d asignada al programa @%lx, asociada a la direcciÛn virtual @%lx\n", pageNumber, (unsigned long) page, (unsigned long) vaddr);
=======
...
//                }
    ...
    DebugVM("DirecciÛn de la ultima tabla de p·ginas del hilo (corresponde a la ˙ltima entrada del page directory): @%lx\n", ultima);
